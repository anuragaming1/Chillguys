...
pcall(function()
	if CoreGui:FindFirstChild("meowhubui") then
		CoreGui.meowhubui:Destroy()
	end
end)

--====================================
-- SCREEN GUI (ABSOLUTE TOP)
--====================================
...
titleShadow.TextColor3 = Color3.fromRGB(150,60,120)
titleShadow.TextTransparency = 0.35
titleShadow.ZIndex = 1199
...
title.TextColor3 = Color3.fromRGB(255,160,230)
title.ZIndex = 1200
title.Parent = main
...
subShadow.TextColor3 = Color3.fromRGB(70,110,170)
subShadow.TextTransparency = 0.35
subShadow.ZIndex = 1199
...
sub.TextScaled = true
sub.TextColor3 = Color3.fromRGB(170,220,255)
sub.ZIndex = 1200
sub.Parent = main
